...
class FirstWithdrawal extends StatelessWidget {
  final Function rebuildHome;
  const FirstWithdrawal({Key? key, required this.rebuildHome})
      : super(key: key);
    ...
    if (prefBalance >= amount) {
      ...
      showDialog(
        ...
        builder: (context) {
          return SimpleDialog(
            title: const Center(
              child: Text('Withdrawal Unuccesful'),
            ),
            contentPadding: const EdgeInsets.fromLTRB(0.0, 12.0, 0.0, 0.0),
            children: [
              const Center(
            ...
            const Center(
              child: Card(
                ...
                child: Padding(
                  ...
                  child: Text(
                    'How much do you want to witdraw ?',
